...
BINDIR   = $(DEVHOME)/bin
EXT_LIB   = $(DEVHOME)/simulator_c
export LD_RUN_PATH=$(EXT_LIB)
...
#
#INC_DIR_USER= -I . 
INC_DIR_USER= -I/usr/include/tango -I. -I /usr/include  -I$(EXT_LIB)
...
#
#LFLAGS_USR+=
LFLAGS_USR+= -lsimulator_cpp
#LFLAGS_USR+= -static -L $(EXT_LIB) -lsimulator_cpp
